...
# Dynamic UB tiling case: two reductions fed by different slice extents.
# The leading axis is dynamic while the reduction and sliced extents stay fixed.
...
CASE = {
    "name": "dynamic_ub_reduction_slice_sum",
