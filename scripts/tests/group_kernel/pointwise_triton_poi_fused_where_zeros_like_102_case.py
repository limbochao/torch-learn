...
def eager_forward(view_723, arg93_1):
    ...
    view_83 = view_723
    full_default_92 = torch.ops.aten.full.default([arg4_1, 12], 0, dtype=torch.float16, layout=torch.strided, device=torch.device('npu:0'), pin_memory=False)
...
CASE = {
    'name': 'pointwise_triton_poi_fused_where_zeros_like_102',
