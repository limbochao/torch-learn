...
def eager_forward(view_723, arg1650_1):
    ...
    view_715 = view_723
    full_default_320 = torch.ops.aten.full.default([arg4_1, 22], 0, dtype=torch.float16, layout=torch.strided, device=torch.device('npu:0'), pin_memory=False)
...
CASE = {
    'name': 'pointwise_triton_poi_fused_where_zeros_like_266',
