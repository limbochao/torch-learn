...
def eager_forward(bitwise_or_6, arg33_1):
    full_default_26 = torch.ops.aten.full.default([arg4_1, 256], 1.0013580322265625e-05, dtype=torch.float16, layout=torch.strided, device=torch.device('npu:0'), pin_memory=False)
