...
def eager_forward(view_723, arg933_1):
    ...
    where_249 = torch.ops.aten.where.self(view_462, full_default_125, arg933_1)
    return where_249
...
def make_inputs(binding, device):
    ...
    arg933_1 = rand_strided(
        (s0, 32),
        (32, 1),
        device=device,
        dtype=torch.float16,
    )
    return (view_723, arg933_1), {}
...
CASE = {
    'name': 'triton_poi_fused_where_zeros_like_92',
