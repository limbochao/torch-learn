...
def eager_forward(view_723, arg142_1):
    ...
    where_113 = torch.ops.aten.where.self(view_93, full_default_161, arg142_1)
    return where_113
...
def make_inputs(binding, device):
    ...
    arg142_1 = rand_strided(
        (s0, 64),
        (64, 1),
        device=device,
        dtype=torch.float16,
    )
    return (view_723, arg142_1), {}
...
CASE = {
    'name': 'triton_poi_fused_where_zeros_like_72',
