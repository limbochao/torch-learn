...
def eager_forward(view_87, arg18_1):
    ...
    slice_176 = torch.ops.aten.slice.Tensor(arg18_1, 1, 42806, 42822)
    where_67 = torch.ops.aten.where.self(view_41, full_default_46, slice_176)
    return where_67
...
CASE = {
    'name': 'triton_poi_fused_slice_where_zeros_like_28',
