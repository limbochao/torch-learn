...
def eager_forward(bitwise_or_9, arg1340_1):
    ...
    full_default_256 = torch.ops.aten.full.default([arg1339_1, 16384], 1.0013580322265625e-05, dtype=torch.float16, layout=torch.strided, device=torch.device(device), pin_memory=False)
