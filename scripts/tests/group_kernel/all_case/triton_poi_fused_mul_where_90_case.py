...
def eager_forward(bitwise_or_1, arg20_1):
    ...
    full_default_21 = torch.ops.aten.full.default([arg4_1, 32], 1.0013580322265625e-05, dtype=torch.float16, layout=torch.strided, device=torch.device(device), pin_memory=False)
