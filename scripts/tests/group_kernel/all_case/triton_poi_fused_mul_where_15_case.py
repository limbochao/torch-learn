...
def eager_forward(bitwise_or_5, arg28_1):
    ...
    full_default_25 = torch.ops.aten.full.default([arg4_1, 328], 1.0013580322265625e-05, dtype=torch.float16, layout=torch.strided, device=torch.device(device), pin_memory=False)
